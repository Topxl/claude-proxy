...
const DIRECTIVE_GROUPAGE = [
  ...
  "  Mesure du 2026-08-27 : les images pesaient 67 % de tout le volume de",
  "  sorties d'outils, 86,6 M de caracteres en trois jours. Passe d'abord par",
  "  `~/Bureau/Projets/contexte/bin/img-lisible.sh <image>`, qui rend un JPEG",
  "  1100 px, 17 fois plus leger et tout aussi lisible, puis lis CE fichier.",
